	...
	t.Run("generated GameAK C++ matches golden content", func(t *testing.T) {
		...
		cases := []struct {
		...
		}{
			{
				...
				golden: `// Code generated by seed v` + generators.SeedVersion + ` from Models/Component/Position.yaml. DO NOT EDIT.
					#pragma once
			...
			},
			{
				...
				golden: `// Code generated by seed v` + generators.SeedVersion + ` from Models/System/MovementSystem.yaml. DO NOT EDIT.
					#pragma once
